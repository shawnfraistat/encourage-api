...
RSpec.describe AdvicesController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new advice" do

        post :create, params: {advice: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(advice_url(Advice.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new advice" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the advice" do
        advice = Advice.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the advice" do
        advice = Advice.create! valid_attributes
